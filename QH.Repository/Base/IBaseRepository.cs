...
namespace QH.IRepository
{
    public interface IBaseRepository<T, TKey> : IDisposable where T : class
    {
        ...
        IBaseRepository<T, TKey> BeginTrans();
        ...
        ///// <returns>影响的行数</returns>
        //int DeleteList(object whereConditions, int? commandTimeout = null);
        ///// <summary>
        ///// 使用where子句删除多个记录
        ///// </summary>
        ...
        /// <returns></returns>
        Task<T> GetAsync(object whereConditions);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="conditions"></param>
        ...
        Task<bool> SoftDeleteAsync(TKey id, IUser _user);

        Task<bool> SoftDeleteAsync(int[] ids, IUser _user);
